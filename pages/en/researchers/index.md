...
<!----------------------------------------------->
  ...
  <div class="hc-block">
    <div class="hc-block-container">
      ...
      <div class="hc-container-subtitle">
        Using sensitive data comes with many challenges, but leveraging real-world data is curcial for solving today’s grand challenges. As a scientist, you should be able to focus on your research with confidence, assured that your data is secure and compliant with all regulations.
      </div>
    </div>
  </div>
  ...
  <div class="hc-block">
    <div class="hc-block-container">
      <div class="hc-container-title">
        High flexibility with scaleable digital labs
      </div>
      <div class="hc-container-subtitle">
        Our digital labs provide you with the creative freedom you need, secured within our high-trust framework. The digital lab simplifies challenges like analyzing, storing and collaborating on your sensitive data.
      </div>
      <div class="hc-container-text">
        We understand that every research project is unique, and every scientist needs a personalized setup. That is why our scalable solution is tailored to your specific requirements, offering flexible options for storage, CPUs, or GPUs.
      </div>
    </div>
  </div>
